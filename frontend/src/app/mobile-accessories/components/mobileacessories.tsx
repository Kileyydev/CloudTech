...
const CACHE_KEY = 'mobile_accessories_cache_v3';
  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        ...
        const filters = [
          'category__slug=mobile-accessories',
          'categories__slug=mobile-accessories',
        ...
        for (const filter of filters) {
          const slug = 'mobile-accessories'; // or use the correct slug for your category
const res = await fetch(`${API_BASE_URL}/products/?categories__slug=${slug}`, {
  cache: 'no-store',
        ...
        if (finalProducts.length === 0)
          throw new Error('No mobile accessories found');
