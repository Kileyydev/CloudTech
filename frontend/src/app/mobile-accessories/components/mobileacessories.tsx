...
const categorySlug = 'mobile-accessories';
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.error('Error fetching mobile accessories:', err);
        if (mounted.current) {
          setSnackbar({ open: true, message: 'Failed to load mobile accessories', severity: 'error' });
          setLoading(false);
        }
      }
    };
