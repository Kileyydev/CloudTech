...
const CACHE_KEY = 'smartphone_accessories_cache_v3';
    ...
    const loadProducts = async () => {
      try {
        ...
        if (finalProducts.length === 0)
          throw new Error('No smartphon accessories found');
        ...
        console.error('Smartphones fetch failed:', err);
        setSnackbar({
          open: true,
          message: err.message || 'Failed to load smartphone accessories',
          severity: 'error',
        });
      } finally {
        setLoading(false);
      ...
      >
        {loading
          ...
          ? (
              ...
              >
                No smarthone accessories available right now.
              </Typography>
            )
