...
export default function OrderConfirmationPage() {
  ...
  // Get order details from URL or localStorage fallback
  ...
  useEffect(() => {
    ...
    if (saved) {
      ...
      setOrderData(data);
      localStorage.removeItem('lastOrder'); // clear after use
    } else {
      // Fallback: reconstruct from cart + URL
        ...
        <Container maxWidth="md">
          <Stack spacing={4} alignItems="center">
            ...
            <Box textAlign="center">
              ...
              <Typography
                variant="h3"
                sx={{ fontWeight: 800, color: '#db1b88', mb: 1 }}
              >
                Order Confirmed!
              </Typography>
