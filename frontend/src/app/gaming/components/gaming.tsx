...
const CACHE_KEY = 'gaming_accessories_cache';
  ...
  useEffect(() => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        console.error('Error fetching gaming accessories:', err);
        if (mounted.current) {
          setSnackbar({ open: true, message: 'Failed to load gaming accessories', severity: 'error' });
          setLoading(false);
        }
      }
    };
